        ...
        <div style="display: inline-block; margin-right: 20px">
          发布：{{
            type == "mv"
              ...
              : videoDetail.publishTime | dateFormat
          }}
        </div>
...
export default {
  ...
  methods: {
    ...
    getVideoDetail() {
      if (this.type == "video") {
        this.$http
          .get("video/detail", { params: { id: this.videoId } })
          .then((res) => {
        ...
        this.$http
          .get("mv/detail", { params: { mvid: this.videoId } })
          .then((res) => {
            console.log(res.data);
            this.videoDetail = res.data.data;
          });
    ...
    getVideoUrl() {
      if (this.type == "video") {
        this.$http
          .get("video/url", { params: { id: this.videoId } })
          .then((res) => {
        ...
        this.$http
          .get("mv/url", { params: { id: this.videoId } })
          .then((res) => {
