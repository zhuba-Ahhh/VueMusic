<template>
  <div class="allMv">
    <div
      style="font-weight: 500; font-size: 25px; margin-bottom: 30px; margin-left: 2%"
    >
      全部MV
    </div>
    <!-- mv标签 -->
...
export default {
  ...
  data() {
    return {
      // 当前选中标签
      languageTag: this.$route.query.languageTag
        ? this.$route.query.languageTag
        : "全部",
      genderTag: this.$route.query.genderTag
        ? this.$route.query.genderTag
        : "全部",
