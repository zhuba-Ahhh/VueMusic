...
// 合并歌曲到播放列表查重
const concatPlayList = (list: songType[]) => {
  // filter过滤无版权及vip歌曲
...
// 当前歌曲在播放列表的索引
const findIndex = (list: songType, playList: songType[]) => {
