          ...
          <div class="cover-info">
            ...
            <div class="cover-author-tags">
              <div class="cover-author" v-if="details.creator">
                ...
                <div class="cover-date">
                  {{ formartDate(details.createTime, "yyyy-MM-dd") }}
                </div>
              </div>
            ...
            <div class="cover-digital">
              <span class="cover-playCount"
                ...
                {{ formartNum(details.playCount) }}次</span
              >
              <span class="cover-collect"
                ><i class="iconfont icon-collect"></i>
                {{ formartNum(details.subscribedCount) }}</span
              >
              <span class="cover-comment"
                ><i class="iconfont icon-comment"></i>
                {{ formartNum(details.commentCount) }}</span
              >
            </div>
...
const subPlayList = async (item) => {
  const { data: res } = await SubPlayList({
    id: item.id,
