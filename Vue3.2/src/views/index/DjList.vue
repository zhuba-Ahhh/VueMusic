      ...
      <div class="dj">
        ...
        >
          ...
          <div class="info">
            ...
            <div class="dj-count">
              <span>共{{ formartNum(item.programCount) }}期</span>
...
import { getHotDj } from "@/apis/modules";
...
const { list, count, loading } = toRefs(info);

// 获取人电台
const GetHotDj = async (params: { limit: number }) => {
