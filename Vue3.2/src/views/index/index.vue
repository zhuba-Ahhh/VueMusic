...
import hot_recom from "@/common/modules/hot_recom";
import new_album from "@/common/modules/new_album";
import new_mv from "@/common/modules/new_mv";
...
const { album_area, album_index, album_list, album_loading, album_count } =
  toRefs(album_info);
